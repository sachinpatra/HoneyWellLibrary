...
//  HoneyWellLibrary
//
//  Created by Sachin Kumar Patra on 1/23/21.
//
...
public class Slider: UIControl {
  ...
  private let renderer = SliderRenderer()
  ...
  private func commonInit() {
    ...
    let gestureRecognizer = RotationGestureRecognizer(target: self, action: #selector(Slider.handleGesture(_:)))
